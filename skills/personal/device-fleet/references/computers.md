...
| `pc` | Desktop PC, GUI/RustDesk, code work on LAN | `ssh pc`, `ssh winpc`, `ssh semyons-pc` | `10.0.0.15` | Windows tailnet entry `100.77.148.51`; Linux SSH env has no Tailscale | LAN SSH works; Tailscale entry offline |
...
- OS from SSH: CachyOS, kernel `7.1.8-1-cachyos` (verified 2026-08-12).
