# Archived source skill: `weights-and-biases`
...
- `references/weights-and-biases-references-sweeps.md` - Comprehensive hyperparameter optimization guide
- `references/weights-and-biases-references-artifacts.md` - Data and model versioning patterns
- `references/weights-and-biases-references-integrations.md` - Framework-specific examples
