# Archived source skill: `spike`

This file preserves the original `spike` skill content after consolidation into `software-development-workflows`. Use the umbrella SKILL.md first; consult this file for detailed recipes.
