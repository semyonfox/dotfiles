# Archived source skill: `python-debugpy`

This file preserves the original `python-debugpy` skill content after consolidation into `software-development-workflows`. Use the umbrella SKILL.md first; consult this file for detailed recipes.
