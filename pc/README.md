...
- Machine profile: `pc`
- Lock screen: Noctalia must be installed; Super+L locks the session
- Hypridle: lock through Noctalia after 10 minutes, display off after 15 minutes, no automatic suspend
