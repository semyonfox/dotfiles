...
- use `skill-authoring` when a repeated failure, correction, or workflow needs durable procedural guidance; keep the trigger description concise and verify the resulting skill in its intended runtime
