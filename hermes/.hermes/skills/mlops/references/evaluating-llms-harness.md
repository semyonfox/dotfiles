# Archived source skill: `evaluating-llms-harness`
...
**Benchmark descriptions**: See [references/evaluating-llms-harness-references-benchmark-guide.md](references/evaluating-llms-harness-references-benchmark-guide.md) for detailed description of all 60+ tasks, what they measure, and interpretation.

**Custom tasks**: See [references/evaluating-llms-harness-references-custom-tasks.md](references/evaluating-llms-harness-references-custom-tasks.md) for creating domain-specific evaluation tasks.

**API evaluation**: See [references/evaluating-llms-harness-references-api-evaluation.md](references/evaluating-llms-harness-references-api-evaluation.md) for evaluating OpenAI, Anthropic, and other API models.

**Multi-GPU strategies**: See [references/evaluating-llms-harness-references-distributed-eval.md](references/evaluating-llms-harness-references-distributed-eval.md) for data parallel and tensor parallel evaluation.
