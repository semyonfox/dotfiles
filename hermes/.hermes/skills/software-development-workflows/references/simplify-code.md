# Archived source skill: `simplify-code`

This file preserves the original `simplify-code` skill content after consolidation into `software-development-workflows`. Use the umbrella SKILL.md first; consult this file for detailed recipes.
