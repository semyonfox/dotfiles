# Archived source skill: `node-inspect-debugger`

This file preserves the original `node-inspect-debugger` skill content after consolidation into `software-development-workflows`. Use the umbrella SKILL.md first; consult this file for detailed recipes.
