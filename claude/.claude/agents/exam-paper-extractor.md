...
description: Extract and validate university exam paper PDFs into standardized JSON (questions, parts, marks, dependencies) with strict mark-sum validation and no hallucination. Use when the user references exam paper PDFs or asks for mark/topic distribution analysis.
model: sonnet
color: cyan
---
