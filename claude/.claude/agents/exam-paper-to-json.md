...
description: Convert exam paper PDFs into structured JSON for pattern/topic/marks analysis across years. Overlaps with exam-paper-extractor — prefer that one for new work.
model: sonnet
color: yellow
---
